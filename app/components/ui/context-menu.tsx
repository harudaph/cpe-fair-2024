...
export const ContextMenuSeparator = (props: React.ComponentProps<typeof ContextMenuPrimitive.Separator>) => {
  return <ContextMenuPrimitive.Separator data-slot="context-menu-separator" className={cn("bg-border -mx-1 my-1 h-px")} {...props} />;
};

export const ContextMenuShortcut = (props: React.ComponentProps<"span">) => {
  return <span data-slot="context-menu-shortcut" className={cn("text-muted-foreground ml-auto text-xs tracking-widest")} {...props} />;
};
