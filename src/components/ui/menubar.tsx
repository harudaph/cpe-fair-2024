...
function MenubarSeparator(props: React.ComponentProps<typeof MenubarPrimitive.Separator>) {
  return <MenubarPrimitive.Separator data-slot="menubar-separator" {...props} />;
}
...
function MenubarSubContent(props: React.ComponentProps<typeof MenubarPrimitive.SubContent>) {
  return (
